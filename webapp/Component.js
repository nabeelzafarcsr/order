sap.ui.define([
	...
	return UIComponent.extend("com.csr.order.Component", {
		...
		init: function () {
			...
			var sServiceBase = sap.ui.require.toUrl("com/csr/order"); //Changes made during Neo to Cloud FOundation Migration - 22/07/2027 by FAIR TEAM
            var oModel = new sap.ui.model.odata.ODataModel(sServiceBase + "/sap/opu/odata/sap/ZPOSITIVE_UTILITY_SRV_SRV");
			
			/*var oModel = new sap.ui.model.odata.v2.ODataModel({
				serviceUrl: "sap/opu/odata/sap/ZPOSITIVE_UTILITY_SRV_SRV"
			});*/
			var oAuthKeyModel = new sap.ui.model.odata.ODataModel(sServiceBase + "/sap/opu/odata/sap//ZPOSITIVE_BPOINT_SRV_SRV");
